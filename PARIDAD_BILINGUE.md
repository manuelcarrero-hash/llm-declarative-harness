...
| `01_nucleo/` | `en/01_core/` | Paridad semántica revisada, incluida taxonomía factual única, propiedad normativa, inicio guiado y revisión previa |
| `02_modulos/` | `en/02_modules/` | Estado integra continuidad; la ruta anterior es un alias bilingüe y los demás módulos conservan comportamiento diferencial |
