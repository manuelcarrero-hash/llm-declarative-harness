...
| `REVIEW_01` | Revisión | Sí para toda entrega; independencia si hubo cambio material | ¿Antes de entregar o persistir se revisaron decisiones inventadas, confusiones, premisas sin sustento, cumplimiento y exposición del arnés; y, para cambios materiales, un revisor independiente inspeccionó el trabajo real? | Checklist proporcional, fuentes, diff, hallazgos, correcciones, reejecución y veredicto |
...
| `STATE_01` | Estado | Sí | ¿El estado autoritativo distinguió hechos actuales, antecedentes, materiales, estilo, propuestas y supuestos; preservó su procedencia; y representó honestamente validación y telemetría? | Snapshot, procedencia, confirmaciones, correcciones y pulso contrastados con fuentes directas |
...
- `REVIEW_01` falla si se entrega o persiste un resultado sin comprobar las cinco categorías de la revisión previa. Si hubo un cambio material, tampoco puede marcarse `NOT_APPLICABLE` sólo porque no se asignó revisor independiente.
...
- `STATE_01` falla si memoria previa, un caso reutilizable, una referencia de estilo, una propuesta o una interpretación del agente se guarda como hecho confirmado sin procedencia ni confirmación; corregir el entregable sin rectificar el estado no repara la falla.
