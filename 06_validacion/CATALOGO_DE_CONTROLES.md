...
- `STATE_01` también falla si un registro nuevo usa `SUPPORTED` como clase factual; ese valor pertenece a capacidad. Sólo los registros factuales anteriores a 0.12.1 pueden normalizarlo como `CORROBORATED`.
