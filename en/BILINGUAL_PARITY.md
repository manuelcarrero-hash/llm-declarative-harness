...
| Spanish area | English area | Status in 0.6.0 |
| --- | --- | --- |
...
| `../02_modulos/` | `02_modules/` | Semantic parity reviewed, including Council, Iteration, level-based orchestration and onboarding evaluation |
