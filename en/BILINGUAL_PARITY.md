...
| `../01_nucleo/` | `01_core/` | Semantic parity reviewed, including one factual taxonomy, normative ownership, guided start and pre-delivery review |
| `../02_modulos/` | `02_modules/` | Status includes continuity; the prior path is a bilingual alias and other modules retain differential behavior |
