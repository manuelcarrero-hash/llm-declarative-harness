...
For one run, use Suite scenarios matching the observed surface. Before declaring a functional version stable, execute all 22 scenarios and preserve stimulus, output, sequence, evidence and verdict. Negative cases must fail the named control, not merely produce a narrative warning.
